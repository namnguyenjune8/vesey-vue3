<template>
  ...
  <div class="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto  md:w-1/2 xl:w-1/2 h-screen  px-6 lg:px-16 xl:px-36 max-md:pb-16   
...
<div class="w-full h-100 mt-24">
  ...
  <form @submit.prevent="signup" class="mt-6" action="#" method="POST">
    ...
    <button type="submit" class="w-full block bg-indigo-500 hover:bg-indigo-400 focus:bg-indigo-400 text-white font-semibold rounded-lg
          px-4 py-3 mt-6 font-lagre min-[4300px]:py-6 min-[4300px]:rounded-2xl">Đăng ký</button>
...
<img src="../assets/signup_image.jpg" alt="" class="w-full h-full object-unset boder-radius-40px page-image">
</div>
