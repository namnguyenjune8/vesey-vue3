...
<div class="w-full h-100">
  ...
  <h1 class="text-3xl md:text-5xl font-normal font-inter leading-tight mt-12 font-hello">Đăng ký!</h1>
  ...
  <form @submit.prevent="signup" class="mt-6" action="#" method="POST">
    <div>
        ...
        <input type="text" name="" id="" placeholder="Nhập họ" class="w-full px-3 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none input-email font-email min-[3000px]:mb-4 " v-model="first_name" autofocus autocomplete required>
        <input type="text" name="" id="" placeholder="Nhập tên đệm & tên" class="w-full px-3 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none input-email font-email " v-model="last_name" autofocus autocomplete required>

      </div>
      <div class="mt-4">
      <label class="block text-gray-700 font-text-account">Số điện thoại</label>
      <input type="number" name="" id="" placeholder="Nhập số điện thoại của bạn" class="w-full px-3 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none input-email font-email " v-model="phone_number" autofocus autocomplete required>
    </div>
    <div class="mt-4">
      <label class="block text-gray-700 font-text-account">Địa chỉ</label>
      <input type="text" name="" id="" placeholder="Nhập địa chỉ của bạn" class="w-full px-3 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none input-email font-email " v-model="address" autofocus autocomplete required>
    </div>
    <div class="mt-4">
      <label class="block text-gray-700 font-text-account">Email</label>
      <input type="email" name="" id="" placeholder="Nhập Email của bạn" class="w-full px-3 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none input-email font-email " v-model="email" autofocus autocomplete required>
    </div>
    ...
    <button type="submit" class="w-full block bg-indigo-500 hover:bg-indigo-400 focus:bg-indigo-400 text-white font-semibold rounded-lg
          px-4 py-3 mt-6 font-lagre">Đăng ký</button>
  ...
  <div class="flex flex-row justify-around">
    ...
    <span class="pt-3 font-lagre">Hoặc</span>
    <hr class="my-6 border-gray-300 w-2/5">
    </div>
  ...
  <p class="mt-8 flex justify-center font-lagre">Bạn đã có tài khoản? <a href="/login" class="text-blue-500 hover:text-blue-700 font-semibold font-lagre">Đăng nhập</a></p>
